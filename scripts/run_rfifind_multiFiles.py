...
class obs_info_class:
    ...
    def __init__(self, args):
        ...
        self.cmd = ['rfifind -psrfits -noscales -nooffsets -noweights {0} -time {1} -o {2} -freqsig {3} -timesig {4}'.format(self.infile, self.rfi_time, self.outfile, self.freqsig, self.timesig)]
